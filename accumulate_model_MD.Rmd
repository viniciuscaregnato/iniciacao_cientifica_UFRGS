...
A sequencia de 1:(nrow(forecast)-2) (1:178) rodará para cada matriz gerada na função anonima.  assim tem 178 trimestres para analisar.
Por fim, retorna os resultados vetorizados.

### 1.2 o sapply() para acc6:
A sequencia de 1:(nrow(forecast)-5) (1:175) rodará para cada matriz gerada na função anonima.  assim tem 175 trimestres para analisar.
Por fim, retorna os resultados vetorizados.

### 1.3 o sapply() para acc6:
A sequencia de 1:(nrow(forecast)-11) (1:168) rodará para cada matriz gerada na função anonima.  assim tem 168 trimestres para analisar.
Por fim, retorna os resultados vetorizados.
