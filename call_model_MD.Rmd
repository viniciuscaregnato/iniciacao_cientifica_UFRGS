...
- objeto model_list[1]: irá caregar o modelo de indice 1, o único que existe na lista
- objeti model_list[[i]]: irá "entrar" no conteudo do modelo de indice i
- objeto model_list[[i]][1]: carrega a primeira lista do modelo i, que é forecast
- objeto model_list[[i]][2]: carrega a segunda lista do modelo i, q é output
- objeto model_list[[i]][[1]]: "entra" na primeira lista, que é forecast
- objeto model_list[[i]][[1]][1]: carrega o primeiro ítem da primeira lista do modelo i
